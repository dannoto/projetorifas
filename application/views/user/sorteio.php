    ...
    <section  class="xl:mt-32 mt-24">
        <div class="grid xl:grid-cols-3 grid-cols-1 xl:ml-10">
            <div class="xl:col-span-2 col-span-1 m-5 ">
                <div>
                    <img style="object-fit:cover ;width:100%;height:400px;max-height:400px" src="<?= base_url() ?>assets/img/raffles/<?= $raffle['raffles_image_featured'] ?>" alt="">
                </div>
                <hr class="mt-5 mb-5" style="opacity: 0.4;">
                <div>
                    <p class="text-white" style="line-break:auto" style="color:#FFF !important"><?= htmlspecialchars_decode($raffle['raffles_description']) ?></p>
                </div>
            ...
            <div class="xl:col-span-1 col-span-1 m-5 ">
                <h1 style="font-size: 35px;line-height: 2rem;" class="text-xl text-white font-bold"><?= $raffle['raffles_title'] ?></h1>
                ...
                <div class="grid place-items-center mt-5 mb-1">
                    ...
                    <?php if ($raffle['raffles_isfree'] == 1) { ?>

                        <p style="font-size: 25px;" class="text-orange mt-5 text-xl font-semibold">GRÁTIS</p>
                    ...
                    <?php } else { ?>
                        ...
                        <?php if ($raffle['raffles_cashback'] == 1) { ?>
                            <p title="Receba cashback, mesmo se não vencer." class="border border-1 border-orange text-orange px-5 py-3 mt-5 font-bold text-xs mt-2 ">CASHBACK <?=$raffle['raffles_cashback_amount']?> %</p>
                        <?php } ?>
                    <?php } ?>
                </div>
                <div class="mt-1 mb-5">
                    <div class="mb-4">
                        ...
                        <div class="flex justify-between" style="font-family: nunito; font-size: 13px;color:#FFF">
                            <div>0</div>
                            <div><?php $rest = ($raffle['raffles_tickets'] - count($this->payments_model->checkBuyedTickets($raffle['id'], null)));
                                    echo $rest; ?> restantes</div>
        ...
        <div class="xl:w-2/3 w-full xl:ml-10">
            ...
            <div class="grid xl:grid-cols-3 grid-cols-1 xl:m-0 m-5">

                <?php if (count($this->raffles_model->getRafflesRelated($raffle['raffles_category'])) == 3) { ?>

                    <?php foreach ($this->raffles_model->getRafflesRelated($raffle['raffles_category'], $raffle['id'])  as $t) { ?>
                ...
                <?php } else { ?>
                    ...
                    <?php foreach ($this->raffles_model->getRafflesRelatedRandom($raffle['id'])  as $t) { ?>
