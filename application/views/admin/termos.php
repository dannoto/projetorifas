...
<body class="bg-dark">
    ...
    <section>
        ...
        <div class=" xl:ml-36 xl:mr-36 xl: mt-12 m-3 perfil-sorteios-breadcumb">
            <h1 class="text-white font-bold text-xl text-3x1">Gerenciar Termos</h1>
            <p class="text-white xl:font-semibold">Edite seus termos.</p>
        ...
        <div class="grid xl:grid-cols-1 xl:ml-36 xl:mr-36 xl:mt-12">
            ...
            <div class="col-span-1 xl:m-0 m-3">
                ...
                <form id="update-form">
                        ...
                        <input type="text" class="form-control input" name="terms_title" required value="<?=$this->admin_model->getTerms()['terms_title']?>"><br><br>

                        <textarea name="terms_content"  class="form-control input"  required style="height: 500px;"><?=$this->admin_model->getTerms()['terms_content']?></textarea>
    ...
    <script>
        ...
        $("#update-form").submit(function(e) {
            ...
            $.ajax({
                url: '<?=base_url()?>painel/updateterms',
                type: 'POST',
                data: formData,
