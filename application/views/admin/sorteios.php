                ...
                <form action="" id="form-raffles">
                    <div class="grid xl:grid-cols-2 grid-cols-1">
                        ...
                        <div class="col-span-1 xl:m-2">
                            ...
                            <select name="raffles_featured" required class="p-2 mt-2 xl:w-full w-full border bg-dark border-orange text-white">
                ...
                <form action="" id="form-edit-raffles">
                    <div class="grid xl:grid-cols-2 grid-cols-1">
                        ...
                        <div class="col-span-1 xl:m-2">
                            ...
                            <label class="text-white " for="">Destaque</label><br>
                            <select name="raffles_featured" id="update_raffles_featured"  required class="p-2 mt-2 xl:w-full w-full border bg-dark border-orange text-white">
                                <option value="1">SIM</option>
                                <option value="0">NÃO</option>
